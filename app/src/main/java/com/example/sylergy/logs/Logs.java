...
public class Logs {
    ...
    public static final String INCORRECT_BARCODE = " Incorrect code. Please, enter a barcode between 8 and 20 digits. ";
    ...
    public static final String INCORRECT_NAME = "Name must be less than 50 digits.";
